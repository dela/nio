; (function($) {
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            var cpHA = [];
            cpHA.push("<div id='BBIT_DP_CONTAINER' class='bbit-dp' style='width:300px;z-index:999;'>");
            if ($.browser.msie6) {
            ...
            cpHA.push("<div id='BBIT-DP-MP' class='bbit-dp-mp'  style='z-index:auto;'><table id='BBIT-DP-T' style='width: 300px; height: 300px' border='0' cellspacing='0'><tbody>");
            cpHA.push("<tr>");
