...
function getCalendarByRange($id) {
    try {
        $db = new DBConnection();
        $db->getConnection();
        $sql = "select * from `nio` where `id` = " . $id;
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $("#Savebtn").click(function() {
                        ...
                        var sd = document.forms["nio_form"]["stpartdate"].value;
                        var ed = document.forms["nio_form"]["etpartdate"].value;
                        /*  var sdarray = sd.split("/");
                         var nsd = sdarray[2] + '/' + sdarray[0] + '/' + sdarray[1];
                         var edarray = sd.split("/");
                         var ned = edarray[2] + '/' + edarray[0] + '/' + edarray[1];*/
                        //$("#fmEdit").submit();
                    ...
                    $("#Deletebtn").click(function() {
                        if (confirm("Are you sure to remove this NIO")) {
    ...
    <body >    
        <div>      
            ...
            <div class="infocontainer">            
                <form name="nio_form" action="php/datafeed.php?method=adddetails<?php echo isset($event) ? "&id=" . $event->Id : ""; ?>" class="fform" id="fmEdit" method="post">                 
                    <label>                    
                        <span>                        *REASON:              
                        </span>                    
                        <!--  <div id="calendarcolor">
                          </div>-->
                        <input MaxLength="200" class="required safe" id="Subject" name="Subject" style="width:95%;" type="text" value="<?php echo isset($event) ? $event->Subject : "" ?>" />                     
